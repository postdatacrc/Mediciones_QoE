...
st.markdown("")
st.markdown("""<p style="text-align:justify;"><b>Para hacer uso del tablero interactivo, por favor seleccione el servicio sobre el cual desea conocer la información de los indicadores de calidad</b></p>""", unsafe_allow_html=True)
...
if select_servicio == 'Internet fijo':
    ...
    if select_indicador== 'Velocidad de descarga':
        ...
        if dimension_Vel_descarga_Fijo == 'Histórico Colombia':
            ...
            with col2:
                mes_opFijo = st.selectbox('Escoja el mes de 2021',['Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre']) 
...
#            with col2b:
        ...
        if dimension_Vel_descarga_Fijo == 'Ciudades':    
            ...
            col1, col2= st.columns(2)
            with col1:
                Año_opFijo20 = st.selectbox('Escoja el año para el panel de la izquierda',[2018,2019,2020],index=2)
                Mes_opFijo20 = st.selectbox('Escoja el mes para el panel de la izquierda',['Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre']) 
                mes20=mes_opFijoNombre[Mes_opFijo20] 
            with col2:
                Mes_opFijo21 = st.selectbox('Escoja el mes de 2021 para el panel de la derecha',['Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre'])           
                mes21=mes_opFijoNombre[Mes_opFijo21]
            ...
            Dic20=Ciudades3Fijo.loc[(Ciudades3Fijo['year']==Año_opFijo20)&(Ciudades3Fijo['month']==mes20)][['Location','Latency','Download Speed Mbps', 'Upload Speed Mbps']]
            Dic21=Ciudades3Fijo.loc[(Ciudades3Fijo['year']==2021)&(Ciudades3Fijo['month']==mes21)][['Location','Latency','Download Speed Mbps', 'Upload Speed Mbps']]
            ...
            fig4Fijo = make_subplots(rows=1, cols=2,subplot_titles=(Mes_opFijo20+' '+str(Año_opFijo20),
            Mes_opFijo21+" 2021"))
...
#            with col2b:
            ...
            st.markdown(r"""<p style=font-size:10px><i>Fuente: Basado en el análisis realizado por CRC de los datos de Speedtest Intelligence® para 2021.<br> Los puntos rojos indican la posición de los servidores de prueba en 2021.</i></p> """,unsafe_allow_html=True)
...
DepJoinAMovilDown['year']=DepJoinAMovilDown['year'].astype('str')
...
DepJoinAMovilUp['year']=DepJoinAMovilUp['year'].astype('str')
...
DepJoinAMovilLat['year']=DepJoinAMovilLat['year'].astype('str')   
...
if select_servicio == 'Internet móvil':
    ...
    if select_indicador== 'Velocidad de descarga':
        ...
        if dimension_Vel_descarga_Movil == 'Histórico Colombia':    
            ...
            with col2:
                mes_opMovil = st.selectbox('Escoja el mes de 2021',['Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre']) 
