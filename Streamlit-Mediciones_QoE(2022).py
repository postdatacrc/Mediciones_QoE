...
pathFijo2='https://raw.githubusercontent.com/postdatacrc/Mediciones_QoE/main/2022/Fijo/'
pathFijo=r'C:\\Users\\santiago.bermudez\\OneDrive - COMISION DE REGULACIÓN DE COMUNICACIONES\\Documentos\\Data Flash\\2022\\2022-016 Mediciones de calidad objetiva QoE 2018-2021\\Descargas\\QoE\\Consolidado\\Datos_Act-Fijo\\'
periodo_tope='2022-12-01'

####Primera sección - Fijo
@st.cache(allow_output_mutation=True)
def Seccion1Fijo():
    Colombia1Fijo=pd.read_csv(pathFijo2+"Colombia-histcomp_month_2018-2022.csv", delimiter=';')
...
@st.cache(allow_output_mutation=True)
def Seccion2Fijo():
    df2_1Fijo=pd.read_csv(pathFijo2+'ETBMOVCLA-histcomp_month_2018-2022.csv',delimiter=';',encoding='latin-1').dropna(how='all') 
    df2_2Fijo=pd.read_csv(pathFijo2+'TIGOEMCALI-histcomp_month_2018-2022.csv',delimiter=';',encoding='latin-1').dropna(how='all') 
...
@st.cache(allow_output_mutation=True)
def Seccion3Fijo():
    df3_1Fijo=pd.read_csv(pathFijo2+'Ciud(1-10)histcomp_month_2018-2022.csv',delimiter=';',encoding='latin-1')
    df3_2Fijo=pd.read_csv(pathFijo2+'Ciud(11-17)histcomp_month_2018-2022.csv',delimiter=';',encoding='latin-1')
    Ciudades3Fijo=pd.concat([df3_1Fijo,df3_2Fijo])#Unir los dataframes
...
@st.cache(allow_output_mutation=True)
def Seccion4Fijo():
    Operadores4Fijo=pd.read_csv(pathFijo2+'Op-histcomp_month_2018-2022.csv',delimiter=';')
...
if select_servicio == 'Internet fijo':
    ...
    if select_indicador== 'Velocidad de descarga':
        ...
        if dimension_Vel_descarga_Fijo == 'Histórico Colombia':
            ...
            title={
            'text': "<b>Velocidad promedio mensual de descarga de internet fijo en <br>Colombia (2018-2022) (en Mbps) </b>",
            'y':0.9,
            'x':0.5,
            'xanchor': 'center',
            'yanchor': 'top'})  
            ...
            Col2Fijo=Colombia2Fijo[(Colombia2Fijo['year']==2022)&(Colombia2Fijo['month']==mes)].groupby(['Location'])['Download Speed Mbps'].mean()
...
#            with col2b:
        ...
        if dimension_Vel_descarga_Fijo == 'Ciudades':    
            ...
            zeroline=True,linecolor = "#000000",zerolinewidth=2,showticklabels=True)
            fig2Fijo.update_yaxes(range=[0,max(DepJoinA3Fijo['2022'].values.tolist())+5],tickfont=dict(family='Arial', color='black', size=14),titlefont_size=14, title_text="Velocidad descarga promedio (Mbps)",ticks="outside", tickwidth=1, tickcolor='black', ticklen=5,
            zeroline=True,linecolor = "#000000",zerolinewidth=2,showticklabels=True) 
            ...
            title={
            'text': "<b>Velocidad promedio anual de descarga de Internet fijo por ciudad<br> (2019-2022) </b>",
            'y':0.85,
            'x':0.5,
            'xanchor': 'center',
            'yanchor': 'top'})  
            ...
            with col1:
                ...
                Mes_opFijoIz = st.selectbox('Escoja el mes para el panel de la izquierda',['Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre']) 
                mesIz=mes_opFijoNombre[Mes_opFijoIz] 
            with col2:
                Mes_opFijoDer = st.selectbox('Escoja el mes de 2022 para el panel de la derecha',['Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre'])           
            ...
            fig4Fijo.update_xaxes(tickangle=0,range=[0,max(DicDer['Download Speed Mbps'].values.tolist())+10],tickfont=dict(family='Arial', color='black', size=16),ticks="outside",tickwidth=1, tickcolor='black', ticklen=5,
            zeroline=True,linecolor = "#000000",zerolinewidth=2,showticklabels=True)
        ...
        if dimension_Vel_descarga_Fijo == 'Operadores': 
            ...
            title={
            'text': "<b>Velocidad promedio mensual de descarga de Internet fijo<br>por proveedor (2018-2022) (en Mbps)</b>",
            'y':0.85,
            'x':0.5,
            'xanchor': 'center',
            'yanchor': 'top'})  
            ...
            col1, col2 ,col3= st.columns(3)
            with col2:
                st.markdown("<center><b> Velocidad de descarga promedio de Internet fijo en Colombia por operador y departamento (en Mbps)</b></center>",unsafe_allow_html=True)                        
            col1b, col2b ,col3b= st.columns([1,4,1])
#            with col2b:
            ...
            fig5Fijo.update_xaxes(range=[0,170],tickangle=0,tickfont=dict(family='Arial', color='black', size=16),ticks="outside",tickwidth=1, tickcolor='black', ticklen=5,
            zeroline=True,linecolor = "#000000",zerolinewidth=2,showticklabels=True)
            fig5Fijo.update_yaxes(range=[0,170],tickfont=dict(family='Arial', color='black', size=16),titlefont_size=16,ticks="outside", tickwidth=1, tickcolor='black', ticklen=5,
            zeroline=True,linecolor = "#000000",zerolinewidth=2,showticklabels=True) 
            ...
            title={
            'text': "<b> Diagrama de burbujas para velocidad de descarga, carga y latencia <br> promedio de Internet fijo por operador</b>",
            'y':0.95,
            'x':0.5,
            'xanchor': 'center',
            'yanchor': 'top'})  
    ...
    if select_indicador== 'Velocidad de carga':
        ...
        if dimension_Vel_carga_Fijo == 'Histórico Colombia':
            ...
            title={
            'text': "<b>Velocidad promedio mensual de carga de Internet fijo<br>en Colombia (2018-2022) (en Mbps)</b>",
            'y':0.9,
            'x':0.5,
            'xanchor': 'center',
            'yanchor': 'top'})  
...
#            with col2b:
        ...
        if dimension_Vel_carga_Fijo == 'Ciudades':    
            ...
            zeroline=True,linecolor = "#000000",zerolinewidth=2,showticklabels=True)
            fig7Fijo.update_yaxes(range=[0,max(DepJoinB3['2022'].values.tolist())+5],tickfont=dict(family='Arial', color='black', size=14),titlefont_size=14, title_text="Velocidad carga promedio (Mbps)",ticks="outside", tickwidth=1, tickcolor='black', ticklen=5,
            zeroline=True,linecolor = "#000000",zerolinewidth=2,showticklabels=True) 
            ...
            title={
            'text': "<b>Velocidad promedio anual de carga de internet fijo por ciudad<br> (2019-2022)</b>",
            'y':0.85,
            'x':0.5,
            'xanchor': 'center',
            'yanchor': 'top'})  
            ...
            showarrow=False,
            text='Fuente: Basado en el análisis realizado por CRC de los datos de Speedtest Intelligence® para 2019 - 2022. Las marcas registradas de Ookla se usan bajo licencia y se reimprimen con permiso.',
            font=dict(size=10), xref='x domain',x=0.1,yref='y domain',y=-0.4)             
        ...
        if dimension_Vel_carga_Fijo == 'Operadores':   
            ...
            title={
            'text': "<b>Velocidad promedio mensual de carga de Internet fijo<br>por proveedor (2018-2022) (en Mbps)</b>",
            'y':0.85,
            'x':0.5,
            'xanchor': 'center',
            'yanchor': 'top'})  
    ...
    if select_indicador== 'Latencia':            
        ...
        if dimension_Latencia_Fijo == 'Histórico Colombia':    
            ...
            title={
            'text': "<b>Latencia promedio mensual de Internet fijo en Colombia<br>(2018-2022)</b>",
            'y':0.9,
            'x':0.5,
            'xanchor': 'center',
            'yanchor': 'top'})  
...
#            with col2b:
        ...
        if dimension_Latencia_Fijo == 'Ciudades':    
            ...
            title={
            'text': "<b>Latencia promedio anual de internet fijo por ciudad en ms<br> (2019-2022) </b>",
            'y':0.9,
            'x':0.5,
            'xanchor': 'center',
            'yanchor': 'top'})  
        ...
        if dimension_Latencia_Fijo == 'Operadores':  
            ...
            title={
            'text': "<b>Latencia promedio mensual de carga de internet fijo en <br> Colombia (2018-2022)</b>",
            'y':0.85,
            'x':0.5,
            'xanchor': 'center',
            'yanchor': 'top'})  
...
pathMovil='https://raw.githubusercontent.com/postdatacrc/Mediciones_QoE/main/2022/Movil'
#pathMovil2=r'C:\\Users\\santiago.bermudez\\COMISION DE REGULACIÓN DE COMUNICACIONES\\Mediciones Calidad QoE - Documents\\Datos\\Internet móvil'
#### Sección 1 Móvil
@st.cache(allow_output_mutation=True)
def ColombiaMovil1():
    Colombia1Movil=pd.read_csv(pathMovil+'/Colombia/Colombiahist_comp(2018a2022_Anual).csv',delimiter=';',encoding='latin1')  
...
@st.cache(allow_output_mutation=True)
def ColombiaMovil2():
    Colombia2Movil=pd.read_csv(pathMovil+'/Departamentos/Desemphistcomp_Dep_Total(2022Mens).csv',delimiter=';',encoding='latin-1') 
...
@st.cache(allow_output_mutation=True)
def ColombiaMovil3():
    Colombia3Movil=pd.read_csv(pathMovil+'/Operadores/Desemphistcomp_Operad_(2018a2022_An).csv',delimiter=';',encoding='utf-8-sig')
...
@st.cache(allow_output_mutation=True)
def OpDepartMovil1():
    df1=pd.read_csv(pathMovil+'/Departamentos/MovAvanETB-hist_comp(2018-2022).csv',delimiter=';',encoding='latin-1')
    df2=pd.read_csv(pathMovil+'/Departamentos/TigoClaroWom-hist_comp(2018-2022).csv',delimiter=';',encoding='latin-1')
...
@st.cache(allow_output_mutation=True)
def CiudadMovil1():
    Ciudades=pd.read_csv(pathMovil+'/Ciudades/Desemphistcomp_Ciud_(2018a2022_An).csv',delimiter=';',encoding='utf-8-sig')
...
CiudadMovil1=CiudadMovil1[CiudadMovil1['Location']!='Colombia']
DepJoinAMovil4=pd.pivot(CiudadMovil1, index=['Location'],
        columns='Aggregate Date', values='Download Speed Mbps').fillna(0).reset_index().rename_axis(None, axis=1).drop('2023 (to date)',axis=1).sort_values(by=['2022'],ascending=False)   
DepJoinAMovil4Up=pd.pivot(CiudadMovil1, index=['Location'],
        columns='Aggregate Date', values='Upload Speed Mbps').fillna(0).reset_index().rename_axis(None, axis=1).drop('2023 (to date)',axis=1).sort_values(by=['2022'],ascending=False)  
DepJoinAMovil4Lat=pd.pivot(CiudadMovil1, index=['Location'],
        columns='Aggregate Date', values='Latency').fillna(0).reset_index().rename_axis(None, axis=1).drop('2023 (to date)',axis=1).sort_values(by=['2022'],ascending=True)          
#### Sección 5 Móvil
@st.cache(allow_output_mutation=True)
def ColombiaMovil5():
    Operadores=pd.read_csv(pathMovil+'/Colombia/Colombiahist_comp(2018a2022_Mensual).csv',delimiter=';',encoding='latin-1')
...
@st.cache(allow_output_mutation=True)
def ColombiaMovil7():
    Colombia7=pd.read_csv(pathMovil+'/Cobertura/Coberturahistcomp_Colombia_(2018-2022).csv',delimiter=';',encoding='latin-1')
...
@st.cache(allow_output_mutation=True)
def DepJoinA8Movil():
    Ciudades8=pd.read_csv(pathMovil+'/Cobertura/Coberturahistcomp_Ciud_(2018-2022).csv',delimiter=',',encoding='utf-8-sig')
...
@st.cache(allow_output_mutation=True)
def OpJoinA9Movil():
    Operadores9=pd.read_csv(pathMovil+'/Cobertura/Coberturahistcomp_Gnral_(2018-2022).csv',delimiter=';',encoding='utf-8-sig')
...
if select_servicio == 'Internet móvil':
    ...
    if select_indicador== 'Velocidad de descarga':
        ...
        if dimension_Vel_descarga_Movil == 'Histórico Colombia':    
            ...
            title={
            'text': "<b>Velocidad promedio anual de descarga de internet móvil en <br>Colombia (2018-2022) (en Mbps) </b>",
            'y':0.9,
            'x':0.5,
            'xanchor': 'center',
            'yanchor': 'top'})  
...
#            with col2b:
        ...
        if dimension_Vel_descarga_Movil == 'Operadores':
            ...
            title={
            'text': "<b>Velocidad promedio anual de descarga de Internet móvil <br>Por operador (2019-2022) (en Mbps) </b>",
            'y':0.9,
            'x':0.5,
            'xanchor': 'center',
            'yanchor': 'top'})          
            ...
            for provider in providers:
                if OpCiudMovil1.loc[(OpCiudMovil1['Provider']==provider)&(OpCiudMovil1['year']==2022)&(OpCiudMovil1['month']==mes),['Location','Download Speed Mbps']].empty:
                    pass
                else:
                    ProveedorMovil = OpCiudMovil1.loc[(OpCiudMovil1['Provider']==provider)&(OpCiudMovil1['year']==2022)&(OpCiudMovil1['month']==mes),['Location','Download Speed Mbps']].groupby(['Location'])[['Download Speed Mbps']].mean().reset_index()
            ...
            choropleth1=folium.Choropleth(
                ...
                legend_name='Velocidad de descarga (Mbps)',
                nan_fill_color = "black",
                smooth_factor=0).add_to(map1_1Movil)
            #######
            #######
            # Adicionar nombres del departamento
            style_function = "font-size: 15px; font-weight: bold"
            choropleth1.geojson.add_child(
                folium.features.GeoJsonTooltip(['DPTO'], style=style_function, labels=False))
            folium.LayerControl().add_to(map1_1Movil)
            ##
            #Adicionar valores porcentaje
            style_function = lambda x: {'fillColor': '#ffffff', 
                                        'color':'#000000', 
            ...
            map1_1Movil.add_child(NIL1)
            map1_1Movil.keep_in_front(NIL1)
            ...
            col1b, col2b ,col3b= st.columns([1,4,1])
            with col2b:
                folium_static(map1_1Movil,width=400) 
        ...
        if dimension_Vel_descarga_Movil == 'Ciudades':
            ...
            title={
            'text': "<b>Velocidad promedio anual de descarga de Internet móvil <br>por ciudad (2018-2022) (en Mbps) </b>",
            'y':0.9,
            'x':0.5,
            'xanchor': 'center',
            'yanchor': 'top'})  
    ...
    if select_indicador== 'Velocidad de carga':
        ...
        if dimension_Vel_carga_Movil == 'Histórico Colombia':    
            ...
            title={
            'text': "<b>Velocidad promedio anual de carga de internet móvil en <br>Colombia (2018-2022) (en Mbps) </b>",
            'y':0.9,
            'x':0.5,
            'xanchor': 'center',
            'yanchor': 'top'})  
...
#            with col2b:
        ...
        if dimension_Vel_carga_Movil == 'Operadores':  
            ...
            title={
            'text': "<b>Velocidad promedio anual de carga de Internet móvil <br>Por operador (2019-2022) (en Mbps) </b>",
            'y':0.9,
            'x':0.5,
            'xanchor': 'center',
            'yanchor': 'top'})          
            ...
            final_dfMovil_dict = {}
            for provider in providers:
                if OpCiudMovil1.loc[(OpCiudMovil1['Provider']==provider)&(OpCiudMovil1['year']==2022)&(OpCiudMovil1['month']==mes),['Location','Upload Speed Mbps']].empty:
                    pass
                else:
                    ProveedorMovil = OpCiudMovil1.loc[(OpCiudMovil1['Provider']==provider)&(OpCiudMovil1['year']==2022)&(OpCiudMovil1['month']==mes),['Location','Upload Speed Mbps']].groupby(['Location'])[['Upload Speed Mbps']].mean().reset_index()
    ...
    if select_indicador== 'Latencia':
        ...
        if dimension_Vel_carga_Movil == 'Histórico Colombia':    
            ...
            zeroline=True,linecolor = "#000000",zerolinewidth=2,showticklabels=True)
            fig5Movil.update_yaxes(tickfont=dict(family='Arial', color='black', size=14),titlefont_size=14, title_text='Latencia promedio (ms)',ticks="outside", tickwidth=1, tickcolor='black', ticklen=5,
            zeroline=True,linecolor = "#000000",zerolinewidth=2,showticklabels=True) 
            ...
            title={
            'text': "<b>Latencia promedio mensual de Internet móvil en<br> Colomia (2018-2022) (en ms)</b>",
            'y':0.85,
            'x':0.5,
            'xanchor': 'center',
            'yanchor': 'top'})  
...
#            with col2b:
        ...
        if dimension_Vel_carga_Movil == 'Operadores':  
            ...
            title={
            'text': "<b>Latencia promedio de Internet móvil <br>Por operador (2019-2022) (en ms) </b>",
            'y':0.9,
            'x':0.5,
            'xanchor': 'center',
            'yanchor': 'top'})          
            ...
            final_dfMovil_dict = {}
            for provider in providers:
                if OpCiudMovil1.loc[(OpCiudMovil1['Provider']==provider)&(OpCiudMovil1['year']==2022)&(OpCiudMovil1['month']==mes),['Location','Latency']].empty:
                    pass
                else:
                    ProveedorMovil = OpCiudMovil1.loc[(OpCiudMovil1['Provider']==provider)&(OpCiudMovil1['year']==2022)&(OpCiudMovil1['month']==mes),['Location','Latency']].groupby(['Location'])[['Latency']].mean().reset_index()
            ...
            col1, col2 ,col3= st.columns(3)
            with col2:
                st.markdown("<center><b> Latencia promedio de Internet móvil en Colombia por operador y departamento (en Mbps)</b></center>",unsafe_allow_html=True)                        
            col1b, col2b ,col3b= st.columns([1,4,1])
            with col2b:
                folium_static(map1_1Movil,width=400) 
                folium_static(dualmap1_2Movil,width=800)
        ...
        if dimension_Vel_carga_Movil == 'Ciudades':         
            ...
            title={
            'text': "<b>Latencia promedio de Internet móvil <br>por ciudad (2019-2022) (en ms) </b>",
            'y':0.9,
            'x':0.5,
            'xanchor': 'center',
            'yanchor': 'top'})  
    ...
    if select_indicador== 'Registro en red':
        ...
        if dimension_Cober4G_Movil=='Operadores':
            ...
            fig13Movil.update_layout(height=600,   
                title="<b>Promedio anual del porcentaje de registro en red 4G por operador<br>(2019-2022)</b>",
                title_x=0.5)
...
#Diciembre de 2022
fijo_Intdict = {'Suriname': [22.05, 15.69, 30],
        'Uruguay': [177.74, 39.09, 15],
        'Brazil': [172.2, 104.92, 12],
        'Argentina': [111.23, 43.92, 21],
        'Ecuador': [66.78, 60.94, 13],
        'Peru': [91.68, 68.57, 18],
        'Bolivia': [33.79, 19.85, 16],
        'Chile': [298.5, 251.67, 13],
        'Paraguay': [99.2,35.02, 14],
        'Colombia': [125.86, 81.51, 19],
        'Venezuela': [41.48, 38.9, 45],
        'Guyana':[92.05,42.47,25]}
...
movil_Intdict = {
        'Uruguay': [61.1, 14.14, 32],
        'Brazil': [118.96, 17.89, 35],
        'Argentina': [33.92, 10.02, 38],
        'Ecuador': [28.56, 12, 39],
        'Peru': [28.3, 15.07, 37],
        'Bolivia': [16.46, 11.84, 33],
        'Chile': [71.69, 16.97, 34],
        'Paraguay': [24.76,10.4, 42],
        'Colombia': [18.84, 11.63, 44],
        'Venezuela': [11.04, 5.94, 46]}
...
if select_servicio == 'Comparación internacional':
    ...
    if select_servicio=='Velocidad de descarga':
        ...
        with col1:
            ...
            st.markdown(r"""<p style=font-size:10px><i>Fuente: Basado en el análisis realizado por CRC de los datos de Speedtest Intelligence® para diciembre de 2022</i></p> """,unsafe_allow_html=True)
    ...
    if select_servicio=='Resumen':
        ...
        fig1Int.update_layout(height=600,   
            title="<b>Diagrama de burbujas con la distribución de velocidades y latencia<br>de Suramérica por país para Internet fijo - Diciembre 2022</b>",
            title_x=0.5,
            titlefont_size=15,
            font=dict(
                family="Arial",
                color=" black",size=16))
        fig1Int.update_layout(legend=dict(y=1.02,x=0.001))
        fig1Int.update_layout(paper_bgcolor='rgba(0,0,0,0)')
        fig1Int.update_layout(plot_bgcolor='rgba(0,0,0,0)')
        fig1Int.add_annotation(
        showarrow=False,
        text='Fuente: Basado en los datos de Ookla® Speedtest Intelligence® para diciembre de 2022.',
        font=dict(size=10), xref='x domain',x=0.5,yref='y domain',y=-0.2)             
        ...
        fig2Int.update_layout(height=600,   
            title="<b>Diagrama de burbujas con la distribución de velocidades y latencia<br>de Suramérica por país para Internet móvil - Diciembre 2022</b>",
            title_x=0.5,
            titlefont_size=15,
            font=dict(
                family="Arial",
                color=" black",size=16))
        fig2Int.update_layout(legend=dict(y=0.87,x=0.001))
